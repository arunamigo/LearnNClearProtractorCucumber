...
var BasePage = function() {
     ...
     * and verify/wait via at()
     * 
     * @requires page have both `uri` and `pageLoaded` properties
     */
    
    this.navigateTo = function(uri) {
        browser.get(uri, this.timeout.xl);
    };
    ...
    /**
     * Click's an provided element
     *
     * @param  {element}
     */
    this.clickElement = function(element) {
        this.elementToClick = element;
     ...
     * @param  {element}
     */
    this.enterText = function(element, string) {
        this.elementToEnterText = element;
        this.elementToEnterText.sendKeys(string);
    };
     ...
     * @param  {element}
     */
    this.enterTextNewly = function(element, string) {    	
        this.elementToEnterText = element;
        this.elementToEnterText.clear();
        this.elementToEnterText.sendKeys(string);
    };
